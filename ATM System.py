...
#c.execute('CREATE TABLE "database" ( "accno" INTEGER NOT NULL, "atm" INTEGER NOT NULL, "balance" INTEGER NOT NULL, PRIMARY KEY("accno") )')
#c.execute("INSERT INTO database VALUES (12345, 1111, 100000)")
